...
class BootGridView extends CGridView
{
	...
	const TYPE_CLICKABLE = 'clickable';
	...
	public function init()
	{
		...
		$validTypes = array(self::TYPE_STRIPED, self::TYPE_BORDERED, self::TYPE_CONDENSED, self::TYPE_CLICKABLE, self::TYPE_HOVER);



		foreach ($this->type as $type)
			if (in_array($type, $validTypes))
				$classes[] = ($type != self::TYPE_CLICKABLE ? 'table-' : '') . $type;
